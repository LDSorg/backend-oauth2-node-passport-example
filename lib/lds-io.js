...
module.exports.create = function (app, passport, conf) {
  ...
  var authorizationRedirect = "/api/oauth3/authorization_redirect/ldsconnect.org";
  var authorizationCallback = "/api/oauth3/callbacks/ldsconnect.org";
  var providerConfig = {
  ...
  passport.use('lds-strategy-1', new LdsConnectStrategy({
    ...
    , callbackURL: conf.url + authorizationCallback
  ...
  app.get(authorizationRedirect, function (req, res, next) {
      var scope;
